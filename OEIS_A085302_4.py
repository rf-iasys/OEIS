...
def get_primorial(n, primes):
    ...
    # Find largest cached primorial <= n
...
# --- Display first 20 and last 20 ---
def report_edges(seq, name):
    print(f"\n{name} - First 20 elements:", seq[:20])
    print(f"{name} - Last 20 elements:", seq[-20:])

report_edges(oeis_n, "OEIS-style n sequence")
report_edges(oeis_k, "Corresponding k values")
report_edges(a085302, "OEIS A085302 locally")

# Check full match
full_match = all(a == b for a, b in zip(oeis_n, a085302))
print("\nLength of OEIS-style n sequence:", len(oeis_n))
print("Length of A085302 sequence:", len(a085302))
print("✅ Full sequence match:", full_match)
