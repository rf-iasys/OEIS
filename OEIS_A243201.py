...
Checks against OEIS A243201 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A243201 ===")
    print("Odd octagonal numbers indexed by triangular numbers.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A243201/b243201.txt"
    try:
