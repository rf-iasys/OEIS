...
Checks against OEIS A033638 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A033638 ===")
    print("Quarter-squares plus 1 (that is, a(n) = A002620(n) + 1).\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A033638/b033638.txt"
    try:
