...
Checks against OEIS A262998 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A262998 ===")
    print("Composite numbers n such that Sum_{k=1..phi(n)} k^phi(n) == phi(n) (mod n), where phi(n) = A000010(n).\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A262998/b262998.txt"
    try:
