...
Checks against OEIS A212133 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A212133 ===")
    print("Number of (w,x,y,z) with all terms in {1,...,n} and median=mean.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A212133/b212133.txt"
    try:
