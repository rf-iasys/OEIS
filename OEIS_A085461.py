...
Checks against OEIS A085461 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int, int] | None = None,
    ...
    print("\n=== OEIS A085461 ===")
    print("Number of 5-tuples (v1,v2,v3,v4,v5) of nonnegative integers less than n such that v1 <= v5, v2 <= v5, v2 <= v4 and v3 <= v4.\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        idx += 1
        value_to_report = int(y/30) if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A085461/b085461.txt"
    try:
