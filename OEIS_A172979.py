...
Checks against OEIS A172979 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A172979 ===")
    print("Primes with locations of right angle turns in Ulam square spiral (primes in A033638).\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A172979/b172979.txt"
    try:
