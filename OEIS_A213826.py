...
Checks against OEIS A213826 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A213826 ===")
    print("Principal diagonal of the convolution array A213825.\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        value_to_report = y-1 if use_y_values else x-1
...
def main():
    ...
    oeis_url = "https://oeis.org/A213826/b213826.txt"
    try:
