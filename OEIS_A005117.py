...
Checks against OEIS A005117 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A005117 ===")
    print("Squarefree numbers: numbers that are not divisible by a square greater than 1.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A005117/b005117.txt"
    try:
