...
Checks against OEIS A004201 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A004201 ===")
    print("Accept one, reject one, accept two, reject two, ...\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        value_to_report = math.isqrt(y) if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A004201/b004201.txt"
    try:
