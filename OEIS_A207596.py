...
Checks against OEIS A207596 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A207596 ===")
    print("Number of n X 5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        value_to_report = 15*y if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A207596/b207596.txt"
    try:
