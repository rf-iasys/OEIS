...
Checks against OEIS A309805 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A309805 ===")
    print("Maximum number of nonattacking kings placeable on a hexagonal board with edge-length n in Glinski's hexagonal chess.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A309805/b309805.txt"
    try:
