...
output_file = "1_14_C.txt"
with open(output_file, "w") as f:
    for k in sorted(irregular_prefixes.keys()):
        f.write(f"Column {k}: {irregular_prefixes[k]}\n")

print(f"✅ Irregular prefixes for columns 4..{k_max-1} saved to '{output_file}'")
