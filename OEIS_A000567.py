...
Checks against OEIS A000567 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A000567 ===")
    print("Octagonal numbers: n*(3*n-2). Also called star numbers.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A000567/b000567.txt"
    try:
