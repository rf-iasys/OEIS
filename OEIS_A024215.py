...
Checks against OEIS A024215 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A024215 ===")
    print("Sum of squares of first n positive integers congruent to 1 mod 3.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A024215/b024215.txt"
    try:
