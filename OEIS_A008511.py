...
Checks against OEIS A008511 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A008511 ===")
    print("Number of points on surface of 4-dimensional cube.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A008511/b008511.txt"
    try:
