...
Checks against OEIS A001983 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A001983 ===")
    print("Numbers that are the sum of 2 distinct squares: of form x^2 + y^2 with 0 <= x < y.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A001983/b001983.txt"
    try:
