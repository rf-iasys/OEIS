...
Checks against OEIS A045531 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A045531 ===")
    print("Number of sticky functions: endofunctions of [n] having a fixed point.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A045531/b045531.txt"
    try:
