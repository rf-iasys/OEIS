...
Checks against OEIS A077017 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A077017 ===")
    print("""a(1) = 2, a(n+1) = smallest positive integer divisible by the n-th prime
...
def main():
    ...
    oeis_url = "https://oeis.org/A077017/b077017.txt"
    try:
