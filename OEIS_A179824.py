...
Checks against OEIS A179824 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A179824 ===")
    print("Chromatic polynomial of the star graph on 4 vertices (claw graph) and the path graph on 4 vertices.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A179824/b179824.txt"
    try:
