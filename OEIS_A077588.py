...
Checks against OEIS A077588 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A077588 ===")
    print("Maximum number of regions into which the plane is divided by n triangles.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A077588/b077588.txt"
    try:
