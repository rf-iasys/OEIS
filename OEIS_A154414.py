...
Checks against OEIS A154414 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A154414 ===")
    print("Primes of the form 20*k^2 + 32*k + 13\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A154414/b154414.txt"
    try:
