...
Checks against OEIS A369304 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A369304 ===")
    print("Numbers k for which the polynomial (x-1)^3*(x+1)^k has more than one zero coefficient.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A369304/b369304.txt"
    try:
