...
Checks against OEIS A095278 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int, int] | None = None,
    ...
    print("\n=== OEIS A095278 ===")
    print("Numbers k such that 4k + 3 is prime\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        idx += 1
        value_to_report = int(y/5) if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A095278/b095278.txt"
    try:
