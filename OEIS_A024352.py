...
Checks against OEIS A024352 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A024352 ===")
    print("Numbers which are the difference of two positive squares, c^2 - b^2 with 1 <= b < c)\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A024352/b024352.txt"
    try:
