"""
Compare combinatorial max_y results with OEIS A221464 sequence.
"""
...
def compute_max_y(n_start: int, n_end: int,
    ...
    for a in range(n_end//2):
        for b in range(a + 1, n_isqrt + a + 1):
...
def run_comparison(n_start: int, n_end: int, oeis_data: dict[int, int] | None = None):
    ...
    print("\n=== OEIS A221464 ===")
    print("Number of 0..n arrays of length 5 with each element unequal to at least one neighbor, starting with 0.\n")
...
def main():
    n_start = 0
    n_end = 1000000
    oeis_url = "https://oeis.org/A221464/b221464.txt"
