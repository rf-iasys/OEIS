...
Checks against OEIS A088915 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A088915 ===")
    print("Nonnegative numbers of the form mn(m+n) with integers m,n.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A088915/b088915.txt"
    try:
