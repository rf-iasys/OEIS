...
Checks against OEIS A153010 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int, int] | None = None,
    ...
    print("\n=== OEIS A153010 ===")
    print("Indices of A153007 where the entry equals zero.\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        idx += 1
        value_to_report = int(y/6) if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A153010/b153010.txt"
    try:
