...
Checks against OEIS A058031 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A058031 ===")
    print("a(n) = n^4 - 2*n^3 + 3*n^2 - 2*n + 1, the Alexander polynomial for reef and granny knots.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A058031/b058031.txt"
    try:
