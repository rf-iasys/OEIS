...
Checks against OEIS A068722 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A068722 ===")
    print("Number of solenoidal flows (flow in = flow out) in a 3 X 3 square array with integer velocities -n .. n.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A068722/b068722.txt"
    try:
