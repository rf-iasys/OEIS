...
Checks against OEIS A181617 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A181617 ===")
    print("Molecular topological indices of the complete graph K_n.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A181617/b181617.txt"
    try:
