...
Checks against OEIS A365081 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A365081 ===")
    print("Numbers k with the property that the symmetric representation of sigma(k) has four parts and its second part is an octagon of width 1 and one of the vertices of the octagon is also the central vertex of the first valley of the largest Dyck path of the diagram.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A365081/b365081.txt"
    try:
