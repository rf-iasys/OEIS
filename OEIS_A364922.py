...
Checks against OEIS A364922 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A364922 ===")
    print("""a(n) is the square of the side length of a simplex whose n-dimensional inner hypervolume is equal to its (n-1)-dimensional
surface hypervolume. As a result, the sequence starts at n=2.\n""")
...
def main():
    ...
    oeis_url = "https://oeis.org/A364922/b364922.txt"
    try:
