"""
Compare combinatorial max_y results with OEIS A264823 sequence.
"""
...
def run_comparison(n_start: int, n_end: int, oeis_data: dict[int, int] | None = None):
    ...
    print("\n=== OEIS A264823 ===")
    print("Centered 16-gonal (or hexadecagonal) primes.\n")
...
def main():
    n_start = 0
    n_end = 100000
    oeis_url = "https://oeis.org/A264823/b264823.txt"
