...
Checks against OEIS A003136 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A003136 ===")
    print("Loeschian numbers: numbers of the form x^2 + xy + y^2; norms of vectors in A2 lattice.\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A003136/b003136.txt"
    try:
