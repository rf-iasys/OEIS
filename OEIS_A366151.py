...
Checks against OEIS A366151 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A366151 ===")
    print("a(n) = T(n, 3), where T(n, k) = Sum_{i=0..n} i^k * binomial(n, i) * (1/2)^(n-k)\n")
...
def main():
    ...
    oeis_url = "https://oeis.org/A366151/b366151.txt"
    try:
