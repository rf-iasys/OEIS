"""
Compare combinatorial max_y results with OEIS A075408 sequence.
"""
...
def run_comparison(n_start: int, n_end: int, oeis_data: dict[int, int] | None = None):
    ...
    print("\n=== OEIS A075408 ===")
    print("Perfect powers pp such that pp+1 is prime.\n")
...
def main():
    n_start = 0
    n_end = 10000
    oeis_url = "https://oeis.org/A075408/b075408.txt"
