...
Checks against OEIS A101375 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        value_to_report = (y+1)//2 if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A101375/b101375.txt"
    try:
