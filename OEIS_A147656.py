...
Checks against OEIS A147656 online sequence if available.
...
def run(n_start: int, n_end: int, oeis_data: dict[int,int] | None = None,
    ...
    print("\n=== OEIS A147656 ===")
    print("The arithmetic mean of the n-th and (n+1)-st cubes, rounded down.\n")
    ...
    for x in sorted(max_y_per_x.keys()):
        ...
        value_to_report = y//2 if use_y_values else x
...
def main():
    ...
    oeis_url = "https://oeis.org/A147656/b147656.txt"
    try:
